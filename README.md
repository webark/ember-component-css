...
This addon allows you to specify a style sheet inside of your component's pod folder. (the component must also provide a `component.js` returning a valid instance of `Ember.Component`)
