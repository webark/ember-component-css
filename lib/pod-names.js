...
function PodNames(inputNode, options) {
  ...
  this.classicRouteStyleDir = options.classicRouteStyleDir;
...
PodNames.prototype.addClass = function(stylePath) {
  var componentPath = componentNames.path(stylePath, this.classicStyleDir, this.classicRouteStyleDir),
      componentClass = componentNames.class(stylePath, this.classicStyleDir, this.classicRouteStyleDir, this.terseClassNames);
